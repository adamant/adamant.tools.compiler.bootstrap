...
namespace Adamant.Tools.Compiler.Bootstrap.Tests.Unit.Parsing
{
    public partial class FunctionBodyParserSpec
    {
        ...
        [NotNull]
        private static StatementSyntax ParseStatementWithoutError([NotNull] ITokenIterator tokenStream)
        {
        ...
        [NotNull]
        private static BlockSyntax ParseBlockWithoutError([NotNull] ITokenIterator tokenStream)
        {
            var parser = NewFunctionBodyParser();
            var diagnostics = new Diagnostics();
