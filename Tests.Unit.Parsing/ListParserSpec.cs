...
using Adamant.Tools.Compiler.Bootstrap.Tests.Unit.Parsing.Fakes;
using Adamant.Tools.Compiler.Bootstrap.Tests.Unit.Parsing.Helpers;
...
namespace Adamant.Tools.Compiler.Bootstrap.Tests.Unit.Parsing
{
    [UnitTest]
    [Category("Parse")]
    public class ListParserSpec
    {
        ...
        public void Empty_list()
        {
            ...
            var l = new ListParser().ParseList(tokens, NotCalled, TypeOf<ICloseParenToken>(), diagnostics);
        ...
        public void One_item_list()
        {
            ...
            var l = ParseListWithoutError<ICloseParenToken>(tokens);
        ...
        public void Unexpected_token_in_list()
        {
            ...
            var l = new ListParser().ParseList(tokens, expressionParser.Parse, TypeOf<ICloseParenToken>(), diagnostics);
        ...
        public void Empty_separated_list()
        {
            ...
            var l = new ListParser().ParseSeparatedList(tokens, NotCalled, TypeOf<ICommaToken>(), TypeOf<ICloseParenToken>(), diagnostics);
        ...
        public void One_item_separated_list()
        {
            ...
            var l = ParseSeparatedListWithoutError<ICommaToken, ICloseParenToken>(tokens);
        ...
        public void Unexpected_token_in_separated_list()
        {
            ...
            var l = new ListParser().ParseSeparatedList(tokens, expressionParser.Parse, TypeOf<ICommaToken>(), TypeOf<ICloseParenToken>(), diagnostics);

            Assert.Collection(l, i => Assert.Equal(parameter, i));
            Assert.Collection(diagnostics.Build(), d => { d.AssertParsingDiagnostic(3002, 0, 4); });
        }

        private static NonTerminal NotCalled([NotNull] ITokenIterator tokens, [NotNull] Diagnostics diagnostics)
        {
        ...
        [NotNull]
        private static SyntaxList<ExpressionSyntax> ParseListWithoutError<TTerminator>([NotNull] ITokenIterator tokens)
        ...
        [NotNull]
        private static SeparatedListSyntax<ExpressionSyntax> ParseSeparatedListWithoutError<TSeparator, TTerminator>([NotNull] ITokenIterator tokens)
