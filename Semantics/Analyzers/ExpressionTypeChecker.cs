...
//        [NotNull]
//        public DataType CheckExpression([CanBeNull] ExpressionSyntax expression)
//        {
...
//                    return mutableType.Type.Computed(EvaluateTypeExpression(mutableType.ReferencedTypeExpression));// TODO make that type mutable
...
//                    CheckExpression(breakExpression.Value);
...
//        /// </summary>
//        [NotNull]
//        public DataType EvaluateTypeExpression([CanBeNull] ExpressionSyntax typeExpression)
//        {
