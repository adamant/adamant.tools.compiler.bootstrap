...
namespace Adamant.Tools.Compiler.Bootstrap.Semantics.Analyzers
{
    public class ExpressionTypeChecker
    {
            ...
            [NotNull] StatementSyntax statement)
        {
            ...
            //                    InferExpressionType(expressionStatement.Expression);
            //                    break;
            //                default:
        ...
        public DataType InferExpressionType([CanBeNull] ExpressionSyntax expression)
        {
            ...
            switch (expression)
            {
                ...
                //                case BooleanLiteralExpressionSyntax _:
                ...
                //                    InferExpressionType(lifetimeType.TypeName);
                ...
                //                    return expression.Type.Computed(CheckAndEvaluateTypeExpression(newObjectExpression.ConstructorExpression));
                ...
                //                    return placementInitExpression.Type.Computed(CheckAndEvaluateTypeExpression(placementInitExpression.InitializerExpression));
                ...
                //                    return expression.Type.Computed(DataType.Unknown);
                //                }
                //                case GenericInvocationSyntax genericInvocation:
                //                {
                ...
                //                    return mutableType.Type.Computed(CheckAndEvaluateTypeExpression(mutableType.ReferencedTypeExpression));// TODO make that type mutable
        ...
        public DataType CheckAndEvaluateTypeExpression([CanBeNull] ExpressionSyntax typeExpression)
        {
            ...
            //            InferExpressionType(typeExpression);
            ...
            [NotNull] ExpressionSyntax typeExpression)
        {
            ...
            //                {
            //                    var type = EvaluateExpression(lifetimeType.TypeName);
            ...
            //                    return EvaluateExpression(mutableType.ReferencedType); // TODO make the type mutable
            //                default:
